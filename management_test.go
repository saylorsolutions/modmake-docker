...
func TestDocker_RemoveImage(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker rmi some-image:latest", err.Error())
}
...
func TestDocker_RemoveImage_Force(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker rmi -f some-image:latest", err.Error())
}
...
func TestDocker_RemoveContainer(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker rm some-container", err.Error())
}
...
func TestDocker_RemoveContainer_Force(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker rm -f some-container", err.Error())
}
...
func TestDocker_Start(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker start some-container", err.Error())
}
...
func TestDocker_Stop(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Equal(t, "docker stop some-container", err.Error())
}
